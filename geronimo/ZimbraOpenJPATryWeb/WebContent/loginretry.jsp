        			...
        			<table border="0" align="center" bordercolor="#333333" bgcolor="#F5F4E0">
              			...
              			<tr>
                			...
                			<td>
                				...
                				<br>
                				<font size=2 color=red class="style13"><%=loginFormHandler.getErrorMsg("userName")%></font>              		
                			</td>
                		</tr>
                		<tr>
                			<td>
                			...
                			<td>
                				...
                				<br>
                				<font size=2 color=red class="style13"><%=loginFormHandler.getErrorMsg("passWord")%></font>              		
                			</td>
                		</tr>
...
<!--button = "return validateForm()">Sign In</button-->
    ...
    <tr>
		<td valign="middle" bordercolor="#333333" bgcolor="#F5F4E0">
			...
			<p align="center"><a href="number_change.jsp"> Change Mobile No.</a></p>
		</td>
	</tr>
</table>
</blockquote>
  ...
  <div align="center">
    <table width="106%" border="0" bordercolor="#336633" bgcolor="#D7CFBE">
	  ...
	  <td width="26%"><div align="center"><a href="help.jsp" class="style11">Help</a></div></td>
