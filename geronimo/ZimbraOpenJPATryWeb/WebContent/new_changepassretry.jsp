...
<body>
	...
	<div id="done-nav" style="display:inline">
		<ul>			
			<li><label title="login"  id="login-nav">Login</label></li>
			<li><label title="changepassword" class="active" id="changepassword-nav">Change Password</label></li>
			<li><label title="faqs"  id="faqs-nav">FAQ's</label></li>
		</ul>
	</div>
	<div id="login" class="content-box" style="display:none">
        <blockquote>
      		<div align="center">
	...
	<div id="changepassword" class="content-box" >
		<form name= "Main1" action="new_changepassprocess.jsp" method=post onsubmit="return validateForm5()">
			<center>
