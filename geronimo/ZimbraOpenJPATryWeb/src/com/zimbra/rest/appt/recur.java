...
public class recur {
    String recur_rule_freq;// this is the frequence at which the alarm should be
			   // repeated
    int recur_until_date;// this is the date until which alarm should be
			 // repeated
    int recur_interval; // this is the intervel period between two consecutive
			// repeats
